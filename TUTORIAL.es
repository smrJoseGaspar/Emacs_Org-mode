...
xtremo de ese segmento de texto, y teclee C-@
...
>> Mueva el cursor hacia la línea en blanco dos líneas abajo de ésta.
   ...
   Note cómo ha alterado la línea: ha substituido la palabra
   «alterado» por «alterado» en cada ocurrencia, después de la
...
>> teclee M-x auto-fill-mode <Return> ahora.  Luego inserte una línea
   ...
   espacios.
   asdfghjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj
   aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaasdfffdsdfdf
   aaaaaaaaaaaaaaaa
...
rellenará por usted.  Para rellenar el párrafo, teclee M-q (META-q)
con el cursor dentro de ese párrafo.
...
>> Teclee C-s de nuevo, para buscar la siguiente ocurrencia de
   «cursor».
>> Ahora teclee <DEL> cuatro veces y vea como se mueve el cursor Teclee <Return> para terminar la búsqueda.
...
>> Teclee C-x 4 C-f seguido del nombre de uno de sus archivos.
   ...
   la ventana inferior.  El curso va allár también.
